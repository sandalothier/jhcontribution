...
@RestController
@RequestMapping("/api/contribution-kafka")
public class ContributionKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ContributionKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ContributionKafkaResource(KafkaProperties kafkaProperties) {
