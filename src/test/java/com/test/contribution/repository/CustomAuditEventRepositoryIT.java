package com.test.contribution.repository;

import com.test.contribution.ContributionApp;
import com.test.contribution.config.Constants;
import com.test.contribution.config.audit.AuditEventConverter;
import com.test.contribution.domain.PersistentAuditEvent;
...
import static com.test.contribution.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
